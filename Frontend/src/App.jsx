...
const EditCourse = React.lazy(() => import("./pages/Educator/EditCourse"));
const CreateLecture = React.lazy(() => import("./pages/Educator/CreateLectures"));
const EditLecture = React.lazy(() => import("./pages/Educator/EditLecture"));
